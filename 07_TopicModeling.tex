...
\section{Das Topic Model der Patentauszüge}
...
\caption{Graph der multidimensionalen Skalierung nach Themenvektoren, gesamter Zeitraum}
\label{tmmds1}
\end{figure}

Der Graph der Abbildung \ref{tmmds1} zeigt das Ergebnis der multidimensionalen Skalierung unserer zehn Firmen für den gesamten Zeitraum. Wir erkennen die drei Firmengruppen Ford und GM, Bosch und Hyundai und Honda, Toyota, Nissan, Denso und Hitachi. Die einzelnen Firmencluster scheinen, mit Ausnahme von Bosch und Hyundai, von der Nationalität der Firmen abzuhängen. So wäre es möglich, dass die einzelnen Länder verschiedene Wortgruppen bei der Formulierung ihrer Patente bevorzugen. Besonders auffällig ist der große Abstand zwischen den Firmen Denso und Bosch, da wir sowohl in Kapitel \ref{ch_jaffe}, als auch in Kapitel \ref{ch:zitat}, eine technologische Nähe der Automobilzulieferer feststellen konnten. Dennoch bleiben einige Zusammenhänge zu den anderen Technologieräumen bestehen. Beispielsweise fällt die Firma Mazda weiterhin aus dem Muster, auch die Firmen Toyota, Nissan und Honda weisen eine gewisse technologische Ähnlichkeit zueinander auf. \\

\begin{figure}[!ht]
\centering
\includegraphics[width=1.0\linewidth]{files/tmmds2.PNG}
\caption{Graph der multidimensionalen Skalierung nach Themenvektoren, Zeitraum: 2000-2010 (links); 2011-2018 (rechts)}
\label{tmmds2}
\end{figure}

Um die Bewegung der Firmen innerhalb von zwei Zeiträumen zu vergleichen wenden wir die Methodik aus \ref{jaffe:zeit} an.  Der Graph der Abbildung \ref{tmmds2} zeigt die Bewegung der Firmen innerhalb der Jahre 2000-2010 und 2011-2018. Honda scheint sich im zweiten Zeitraum etwas von Toyota zu entfernen. Die Bewegung von GM hin zu Ford und Bosch ist die deutlichste. Für die anderen Firmen lassen sich keine absoluten Aussagen treffen. 

Um die Aussagekraft des Graphen zu steigern, nehmen wir mehr Firmen in die Berechnung auf. Wir betrachten die ersten 20 Firmen nach ihrer Anzahl an Patenten in der $Y02T\_10$ Klasse. 

\begin{figure}[!ht]
\centering
\includegraphics[width=1.0\linewidth]{files/tmmds3.PNG}
\caption{Graph der multidimensionalen Skalierung nach Themenvektoren, gesamter Zeitraum, 20 Firmen}
\label{tmmds3}
\end{figure}

Der Graph der Abbildung \ref{tmmds3} zeichnet ein klares Bild ab. Ausgenommen die Firma Hyundai, befinden sich alle Automobilunternehmen der westlichen Hemisphäre in einem Cluster. Die Firmen östlichen Ursprungs befinden sich auf der anderen Seite des Technologieraums. Wir gehen davon aus, dass dieses Ergebnis eine Mischung aus unterschiedlichem Sprachgebrauch und einem unterschiedlichen Technologiefokus zwischen den beiden Firmenclustern ist.

Um die Technologiethese zu stützen wählen wir einen Repräsentanten aus jeweils einem Firmencluster und untersuchen die Unterschiede der Themenvektoren. So erkennen wir zwischen den Firmen VW und Toyota große Unterschiede in den jeweiligen Auffangthemen. Die Gruppierung der Patente in diesen Themen lässt sich allerdings nicht ohne weiteres auf ein gemeinsame Technologie zurückführen. Dennoch sind auch Unterschiede in sinnvollen Themen zu erkennen. So hat Toyota besonders viele Patente mit dem Thema \glqq Elektromobilität und Hybridtechnik\grqq{topict} (siehe Abbildung). Auf der anderen Seite hält der Volkswagen Konzern die meisten Patente mit der Thematik \glqq Emissionsreduktion\grqq{} (siehe Abbildung \ref{topicvw}). 
