...
\caption{Graph der multidimensionalen Skalierung nach Patentvektoren, gesamter Zeitraum (1970-2018)}
\label{mdsjaffe1}
\end{figure}
...
Wir betrachten die Zeiträume der Jahre 2000 bis 2010 und 2011 bis 2018. Daraus ergeben sich die beiden Graphen der Abbildung \ref{mdsjaffe2}. Die Bewegung der Firma Mazda wird bei einem Vergleich der beiden Zeiträume deutlich. Im ersten Zeitraum befindet sich das Unternehmen am Rande des Technologieraums, allerdings ist eine Nähe zu den beiden Technologieclustern festzustellen. Im zweiten Zeitraum gleicht sich das Innovationsverhalten der Firmen Hyundai, Ford, GM, Denso und Bosch dem der anderen Firmen an, wobei Mazda eine andere Richtung einschlägt.


\begin{figure}[!ht]
\centering
\includegraphics[width=1.0\linewidth]{files/mdsjaffe2.PNG}
\caption{Graph der multidimensionalen Skalierung nach Patentvektoren, Zeitraum: 2000-2010 (links); 2011-2018 (rechts)}
\label{mdsjaffe2}
\end{figure}
...
\caption{Graph der multidimensionalen Skalierung nach Patentvektoren, zwei Distanzmetriken, \glqq min-complement distance\grqq{} (links), Kosinus-Ähnlichkeit (rechts)}
\label{mdsjaffe3}
\end{figure}
